...
\begin{proof}
\leanok
The proof is fully formalized in \texttt{SNumbers/Kolmogorov.lean}. (S1)
properties and (S4) follow from the definitions and Riesz, (S2)/(S3) use
the per-subspace deviation lemmas
\texttt{deviationFromSubspace\_add\_le} and
\texttt{deviationFromSubspace\_comp\_comp\_map\_le}, and (S5$'$) is
\texttt{kolmogorovNumber\_strict}.
\end{proof}
